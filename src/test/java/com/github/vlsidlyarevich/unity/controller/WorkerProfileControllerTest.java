...
public class WorkerProfileControllerTest {
    ...
    public void getAllWorkerProfilesTest() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.request(HttpMethod.GET, "/api/workers")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].name.lastName", is(worker.getName().getLastName())))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].gender", is(worker.getGender().toString())))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.[1].name.lastName", is(anotherWorker.getName().getLastName())))
