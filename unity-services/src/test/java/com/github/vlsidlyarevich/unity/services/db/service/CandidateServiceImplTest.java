...
public class CandidateServiceImplTest {
    ...
    public void createTest() throws Exception {
        ...
        CandidateDTO dto = TestUtils.generateCandidateDTO();
    ...
    public void findAllTest() throws Exception {
        Vacancy vacancy = TestUtils.generateVacancy();
        CandidateDTO candidate = TestUtils.generateCandidateDTO();
        CandidateDTO anotherCandidate = TestUtils.generateCandidateDTO();
        vacancyRepository.save(vacancy);
    ...
    public void updateTest() throws Exception {
        ...
        CandidateDTO updated = TestUtils.generateCandidateDTO();
