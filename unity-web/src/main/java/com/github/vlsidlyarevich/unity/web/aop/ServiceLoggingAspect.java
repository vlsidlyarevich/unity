...
public class ServiceLoggingAspect {
    ...
    @Before("execution(* com.github.vlsidlyarevich.unity.web.service.impl.WorkerProfileServiceImpl.*(..)))")
    ...
    @Before("execution(* com.github.vlsidlyarevich.unity.web.service.impl.WorkerProfileSearchServiceImpl.*(..)))")
    ...
    @Before("execution(* com.github.vlsidlyarevich.unity.web.service.impl.FileSystemStorageService.*(..)))")
    public void imageServiceLog(JoinPoint joinPoint) {
        logger.info("Image service : " + joinPoint.getSignature().getName()
                + "\n With arguments : " + Arrays.toString(joinPoint.getArgs()));
    }

    @Before("execution(* com.github.vlsidlyarevich.unity.web.service.impl.VacancyServiceImpl.*(..)))")
    public void vacancyServiceLog(JoinPoint joinPoint) {
        logger.info("Vacancy service : " + joinPoint.getSignature().getName()
                + "\n With arguments : " + Arrays.toString(joinPoint.getArgs()));
    }

    @Before("execution(* com.github.vlsidlyarevich.unity.web.service.impl.CandidateServiceImpl.*(..)))")
